...
<html lang="en" id="home">
  <head>
    ...
    <title>MenuKu</title>
    <link rel="shorcut icon" type="text/css" href="img/food-2085075_960_720.png">
  ...
  <body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg shadow">
      <a class="navbar-brand" href="#">
        <img src="img/food-2085075_960_720.png" alt="Logo" width="20px" height="20px" class="pt-1 mr-2"> 
        <?php 
        if($id_login==""){
          echo "MenuKu";
        }else{
    ...
    if($id_login==""){?>
      ...
      <div class="jumbotron text-center">
        <img src="img/food-2085075_960_720.png" alt="Logo"  >
        <h1 class="textWarning">MenuKu</h1>
        <p class="kopi">All You Can Chose </p>
      </div>
      <!-- Akhir Jumbtron -->
      <?php 
    }?>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <p class="footer">&copy; Copyright <?= date('Y'); ?> | MenuKu</p>
          </div>
        </div>
      </div>
    </footer>
